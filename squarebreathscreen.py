...
class SquareBreathScreen(Screen):
    def __init__(self, parentname, **kwargs):
        ...
        self.layout.add_widget(Label(text="Intervallatmung", size_hint=(0.5, 0.1),
        ...
        self.label_time = Label(text="00:00", font_size="10pt", size_hint=(0.9, 0.1), pos_hint={'x': 0.05, 'y': 0.72})
        ...
        label_todo_state3 = Label(text=text, font_size="7pt",
        ...
        label_todo_state4 = Label(text=text, font_size="7pt",
